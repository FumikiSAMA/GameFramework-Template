...
namespace Fumiki
{
    public static class SoundExtension
    {
        ...
        public static int? PlayMusic(this SoundComponent soundComponent, int musicId, object userData = null)
        {
            ...
            _musicSerialId = soundComponent.PlaySound(AssetUtility.GetMusicAsset(drMusic.AssetName), "Music", Constant.AssetPriority.MusicAsset, playSoundParams, null, userData);
        ...
        public static int? PlaySound(this SoundComponent soundComponent, int soundId, EntityLogicBase bindingEntity = null, object userData = null)
        {
