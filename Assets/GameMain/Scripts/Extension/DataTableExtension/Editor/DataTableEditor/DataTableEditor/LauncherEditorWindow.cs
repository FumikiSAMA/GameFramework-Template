...
namespace Fumiki.Editor.DataTableEditor
{
    public class LauncherEditorWindow : EditorWindow
    {
        ...
        [MenuItem("DataTable/DataTableEditor", priority = 0)]
        ...
        private void ButtonNew()
        {
            ...
            m_DataTableEditingWindow.SetData(Utility.DataTableUtility.NewDataTableFile(m_CurrentEncoding), m_CurrentEncoding);
        }
