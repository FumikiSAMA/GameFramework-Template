...
namespace Fumiki
{
    public static class AssetUtility
    {
        ...
        public static string GetFontAsset(string language, string assetName)
        {
            return Utility.Text.Format("Assets/GameMain/Fonts/FontAssets/{0}/{1}.asset", language, assetName);
        }
        ...
        {
            return Utility.Text.Format("Assets/GameMain/Models/{0}.prefab", assetName);
        }
